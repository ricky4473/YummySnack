;(function (global, factory) {
  ...
  $(document).ready(function () {
    ...
    if (polar !== null) {
      var configPolar = {
        ...
        options: {
          ...
          layout: { padding: { top: 10, bottom: 10, right: 10, left: 10 } },
          title: { display: false, text: 'Chart.js Polar Area Chart' },
          scale: {
            ticks: { beginAtZero: true, fontColor: '#1b223c', fontSize: 12, stepSize: 10, max: 60 },
            reverse: false,
          },
    ...
    if (radar !== null) {
      var myRadar = new Chart(radar, {
        ...
        options: {
          ...
          maintainAspectRatio: false,
          legend: { display: false },
          title: { display: false, text: 'Chart.js Radar Chart' },
          layout: { padding: { top: 10, bottom: 10, right: 10, left: 10 } },
          scale: {
            ticks: { beginAtZero: true, fontColor: '#1b223c', fontSize: 12, stepSize: 10, max: 60 },
          },
        ...
        options: {
          ...
          scales: {
            ...
            yAxes: [
              {
                gridLines: { display: true, color: '#eee', zeroLineColor: '#eee' },
                ticks: { beginAtZero: true, stepSize: 50, max: 200 },
              },
            ],
          },
          tooltips: {
    ...
    if (activity !== null) {
      var activityData = [
        { first: [0, 65, 52, 115, 98, 165, 125], second: [45, 38, 100, 87, 152, 187, 85] },
        { first: [0, 65, 77, 33, 49, 100, 100], second: [88, 33, 20, 44, 111, 140, 77] },
        { first: [0, 40, 77, 55, 33, 116, 50], second: [55, 32, 20, 55, 111, 134, 66] },
        { first: [0, 44, 22, 77, 33, 151, 99], second: [60, 32, 120, 55, 19, 134, 88] },
      ]
      var config = {
        type: 'line',
        data: {
        ...
        options: {
          ...
          legend: { display: false },
          scales: {
            xAxes: [{ gridLines: { display: false }, ticks: { fontColor: '#8a909d' } }],
            yAxes: [
              {
                gridLines: {
                  fontColor: '#8a909d',
                ...
                ticks: { stepSize: 50, fontColor: '#8a909d', fontFamily: 'Roboto, sans-serif' },
              },
            ],
          },
          tooltips: {
    ...
    if (hbar1 !== null) {
      var hbChart1 = new Chart(hbar1, {
        ...
        data: {
          ...
          datasets: [{ label: 'signup', data: [18, 13, 9.5], backgroundColor: '#4c84ff' }],
        },
        options: {
          responsive: true,
          maintainAspectRatio: false,
    ...
    if (hbar2 !== null) {
      var hbChart2 = new Chart(hbar2, {
        ...
        data: {
          ...
          datasets: [{ label: 'signup', data: [7.5, 4.6, 4], backgroundColor: '#4c84ff' }],
        },
        options: {
          responsive: true,
          maintainAspectRatio: false,
  ...
  if (bar1 !== null) {
    var myChart = new Chart(bar1, {
      ...
      data: {
        ...
        datasets: [{ label: 'signup', data: [5, 7.5, 5.5, 6.5, 4, 9], backgroundColor: '#4c84ff' }],
      },
      options: {
        responsive: true,
        maintainAspectRatio: false,
  ...
  if (bar2 !== null) {
    var myChart2 = new Chart(bar2, {
      ...
      data: {
        labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
        datasets: [{ label: 'signup', data: [5, 7.5, 5.5, 6.5, 4, 9], backgroundColor: '#ffffff' }],
      },
      options: {
        responsive: true,
        maintainAspectRatio: false,
  ...
  $(function () {
    ...
    function markerMap() {
      ...
      var marker = new google.maps.Marker({ position: colorado, map: map })
  ...
  if (worldMap.length != 0) {
    worldMap.vectorMap({
      ...
      markers: [
        { latLng: [54.673629, -62.347026], name: 'America', style: { fill: 'limegreen' } },
        { latLng: [62.466943, 11.797592], name: 'Europe', style: { fill: 'orange' } },
        { latLng: [23.956725, -8.768815], name: 'Africa', style: { fill: 'red' } },
        { latLng: [-21.943369, 123.102198], name: 'Australia', style: { fill: 'royalblue' } },
      ],
    })
  }
  var mapData2 = { IN: 19e3, US: 13e3, TR: 9500, DO: 7500, PL: 4600, UK: 4e3 }
  ...
  if (analyticWorldMap.length != 0) {
    analyticWorldMap.vectorMap({
      ...
      series: {
        regions: [
          { values: mapData2, scale: ['#6a9ef9', '#b6d0ff'], normalizeFunction: 'polynomial' },
        ],
      },
    })
  }
  ...
  if (demoWorldMap.length != 0) {
    demoWorldMap.vectorMap({
      map: 'world_mill',
      backgroundColor: 'transparent',
      regionStyle: { initial: { fill: '#9c9c9c' } },
    })
  }
  $(document).ready(function () {
    ...
    if (laddaButton.length != 0) {
      Ladda.bind('.ladda-button', { timeout: 5e3 })
    ...
    $('.slim-scroll-right-sidebar-2')
      .slimScroll({ opacity: 0, height: '100%', color: '#999', size: '5px', touchScrollStep: 50 })
      .mouseover(function () {
        $(this).next('.slimScrollBar').css('opacity', 0.4)
      })
    var circle = $('.circle')
    var gray = '#f5f6fa'
    if (circle.length != 0) {
      circle.circleProgress({ lineCap: 'round', startAngle: 4.8, emptyFill: [gray] })
    }
  })
  $(function () {
